...
<form action="{{url('admin/product/update/new'.$products->id)}}" method="post" enctype="multipart/form-data" style="margin:30px 0;">
                {{ csrf_field() }}
    ...
    <label>Артикул</label>
    <input type="text" class="form-control" name="article" value="{{$products->article}}"> 
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="{{$products->description}}" name="desc"> 
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label>Выбранное изображение {{$products->picture}}</label>
    <input type="file" name="file">
  </div>
  <div class="form-group">
    <label>Надпись красным</label>
    <input type="text" class="form-control" value="{{$products->redarea}}" name="red"> 
  </div>
  <div class="form-group">
    <label>Надпись зеленым</label>
    <input type="text" class="form-control" value="{{$products->greenarea}}" name="green"> 
  </div>
